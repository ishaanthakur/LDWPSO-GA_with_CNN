...
search_config = {
    ...
    "keras.layers.Dense.6": {"units": range(4, 201, 25), "activation": ["sigmoid", "relu", "tanh"]},
    "keras.layers.Dense.7": {"units": range(4, 201, 25), "activation": ["sigmoid", "relu", "tanh"]},
